...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F9F6] p-8 flex flex-col gap-8">
      {/* Judul Dashboard */}
      <h1 className="text-4xl font-bold text-[#3B5D2A] mb-4">Dashboard</h1>
      ...
      <div className="flex flex-col lg:flex-row gap-6 w-full">
        {/* Kebun Virtual */}
        <div className="flex-1 bg-[#EAF3E2] rounded-xl shadow p-6 w-full">
        ...
        {/* To-Do List */}
        <div className="flex-1 bg-white rounded-xl shadow p-6 w-full">
